...
_f.Frm.prototype.refresh_header=function(){if(!this.meta.in_dialog||this.in_form){frappe.utils.set_title(this.meta.issingle?this.doctype:this.docname);}
...
_f.Frm.prototype.render_form=function(){if(!this.meta.istable){this.layout.doc=this.doc;this.layout.attach_doc_and_docfields()
this.sidebar=new frappe.ui.form.Sidebar({frm:this,page:this.page});this.refresh_header();this.script_manager.trigger("refresh");$(document).trigger('form_refresh');this.refresh_fields();if(this.cscript.is_onload){this.script_manager.trigger("onload_post_render");}
...
var on_error=function(){console.log("here",doc_before_action);frappe.model.add_to_locals(doc_before_action);me.frm.refresh();}
