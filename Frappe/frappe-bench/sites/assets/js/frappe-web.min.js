...
return ret;};window.__=frappe._;function prettyDate(time,mini){if(moment){if(sys_defaults.time_zone){var ret=moment.tz(time,sys_defaults.time_zone).fromNow(mini);}else{var ret=moment(time).fromNow(mini);}
